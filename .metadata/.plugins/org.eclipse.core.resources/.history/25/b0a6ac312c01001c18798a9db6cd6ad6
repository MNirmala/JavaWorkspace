...
public class InstructorController {
	...
	/*
	 * @DeleteMapping("/instructors/{id}") public Map < String, Boolean >
	 * deleteUser(
	 * 
	 * @PathVariable(value = "id") Long instructorId) throws
	 * ResourceNotFoundException { Instructor instructor =
	 * instructorRepository.findById(instructorId) .orElseThrow(() -> new
	 * ResourceNotFoundException("Instructor not found :: " + instructorId));
	 * 
	 * instructorRepository.delete(instructor); Map < String, Boolean > response =
